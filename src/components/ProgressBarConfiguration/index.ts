...
import { ProgressBarConfiguration } from './ProgressBarConfiguration';
...
function mount(containerId: string, props: any) {
  ...
  root.render(React.createElement(ProgressBarConfiguration, props));
}
...
(window as any).ReactWidgets['ProgressBarConfiguration'] = { mount, update, unmount };
